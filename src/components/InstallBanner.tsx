...
export function InstallBanner() {
  ...
  if (iosShow) {
    ...
    return (
      <div className="fixed bottom-4 left-4 right-4 z-50 max-w-sm mx-auto" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
        <div className="bg-[#0B1F3A] text-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="p-4 flex items-center gap-3">
            ...
            <button
              ...
              className="bg-white text-[#0B1F3A] text-xs font-black px-3 py-2 rounded-xl shrink-0 hover:bg-white/90 transition-colors"
            >
