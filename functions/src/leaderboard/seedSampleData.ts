...
const SUBJECTS = ["mathematics", "science", "english", "hindi", "social"] as const;

interface SeedInput {
  schoolId?: unknown;
  classId?: unknown;
  // Optional: clear seeded docs first (keyed by a marker field we set).
  clearExistingSeed?: unknown;
}
...
export async function seedSampleDataImpl(
  input: SeedInput,
